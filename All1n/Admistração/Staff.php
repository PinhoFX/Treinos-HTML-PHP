...
?>
  ...
  <div class="bg">  
  <h1> Staff </h1>
    <form action="../Staff/addstaff.php" method="POST" enctype="multipart/form-data">
              ...
              while ($user_data = mysqli_fetch_assoc($result)) {
                  ECHO
                       "<div class=card>
                         ...
                         <a class='btn btn-sm btn-primary' href='../Staff/editstaff.php?id=$user_data[id]'>
                        ...
                        <a class='btn btn-sm btn-primary' href='../Staff/delete.php?id=$user_data[id]'>
